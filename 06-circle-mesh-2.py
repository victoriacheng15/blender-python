...
first_circle.rotation_euler.y = radians
first_circle.location.z = radius

second_circle = create_circle_obj(vert_count, radius)
second_circle.rotation_euler.y = radians
second_circle.rotation_euler.z = radians
second_circle.location.z = radius